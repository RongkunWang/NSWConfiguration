...
OpcUa_Double AnalogInputSystem::readGeneralRefreshRate (
    UaStatus *out_status,
    ...
    UaDateTime *serverTimeStamp)
{
    ...
    UaNodeId nodeId ( UaString(m_objId.identifierString()) + UaString(".generalRefreshRate"), m_objId.namespaceIndex() );
...
void  AnalogInputSystem::writeGeneralRefreshRate (
    OpcUa_Double & data,
    UaStatus                                 *out_status)
{
    ServiceSettings   ss;
...
UaString AnalogInputSystem::readDiagnostics (
    UaStatus *out_status,
    UaDateTime *sourceTimeStamp,
    UaDateTime *serverTimeStamp)
{
    ...
    UaNodeId nodeId ( UaString(m_objId.identifierString()) + UaString(".diagnostics"), m_objId.namespaceIndex() );
