...
macro(build_UaoClientForOpcUaSca)
  ...
  set(UAO_PROTOBUF_VERSION "2.5.0-47665" CACHE INTERNAL "")
  set(UAO_PROTOBUF_RELEASE $ENV{CMTCONFIG} CACHE INTERNAL "")
  set(PROTOBUF_ROOT "${UAO_PROTOBUF_LCG_DIR}/releases/protobuf2/${UAO_PROTOBUF_VERSION}/${UAO_PROTOBUF_RELEASE}" CACHE INTERNAL "")
