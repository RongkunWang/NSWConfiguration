...
nsw::hw::MMTP_v1::MMTP_v1(OpcManager& manager, const boost::property_tree::ptree& config):
...
void nsw::hw::MMTP_v1::writeConfiguration(bool doAlignArtGbtx) const
{
...
std::map<std::string, std::uint32_t> nsw::hw::MMTP_v1::readConfiguration() const
{
...
void nsw::hw::MMTP_v1::writeRegister(std::string_view regAddress,
...
std::uint32_t nsw::hw::MMTP_v1::readRegister(std::string_view regAddress) const
{
...
void nsw::hw::MMTP_v1::writeAndReadbackRegister(std::string_view regAddress,
                                             const std::uint32_t value) const
{
...
void nsw::hw::MMTP_v1::toggleIdleStateHigh() const
{
...
std::set<std::uint8_t> nsw::hw::MMTP_v1::SkipFibers() const
{
...
std::vector<std::uint32_t> nsw::hw::MMTP_v1::readAlignment(const size_t n_reads) const
{
...
void nsw::hw::MMTP_v1::setHorxEnvMonAddr(const bool tx, const std::uint8_t microPod, const bool temp, const bool loss, const std::uint8_t fiber) const {
...
void nsw::hw::MMTP_v1::alignArtGbtx() const
{
  ...
  // check ART/MMTP_v1 communication
  ...
  while (true) {
    ...
    // read MMTP_v1 alignment register
