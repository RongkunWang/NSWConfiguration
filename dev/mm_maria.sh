...
CALIBR="${BIN}/calibrate_trimmers_multirms_maria"
...
time python NSWConfiguration/app/threshold_parallel_BB5.py -rms $RMS -c $CONFIG -s $CALIBR -f $MMFE8S -m $THREADS --remove_disconnected
