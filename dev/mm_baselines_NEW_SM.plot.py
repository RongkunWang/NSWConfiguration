...
def options():
    ...
    parser.add_argument("-t", help="Type of chamber", default="SM")                                                                                                                                          
...
def main():
    ...
    for feb in febs:
        ...
        number_miss_channels = missing_channels(name,"SM")
        for bin in range(1, p_sigma.GetNbinsX()+1):
                ...
                if 513 - bin > number_miss_channels:
                    ...
                    if p_sigma.GetBinContent(bin) == missing_channels_distr.GetBinContent(bin):
                        count_down_sigma = count_down_sigma - 1
