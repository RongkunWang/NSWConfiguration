...
#MMFE8S="MMFE8_L3P4_IPL"

#
# How to choose only a single board
#MMFE8S="MMFE8_L2P6_IPR,MMFE8_L2P6_IPL,MMFE8_L2P7_IPL"
#

#NOW="2020_06_22_20h08m33s"
...
##################CONFIG="/afs/cern.ch/user/n/nswdaq/public/sw/config-ttc/config-files/config_json/BB5/A08/full_small_sector_a08_bb5_baselines.json"
...
#python NSWConfiguration/dev/mm_baselines_layer_FULL.plot.py -i $OUT/baselines.txt -o $OUT/baselines_${NOW}.root -y 5 | tee $OUT/rms.txt
