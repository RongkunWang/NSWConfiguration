# TODO: sTGC 
#FEBs="PFEB_L1Q1,PFEB_L1Q2,SFEB8_L1Q1,SFEB6_L1Q2,PFEB_L2Q1,PFEB_L2Q2,PFEB_L2Q3,SFEB8_L2Q1,SFEB6_L2Q2,SFEB6_L2Q3,PFEB_L3Q1,PFEB_L3Q2,PFEB_L3Q3,SFEB8_L3Q1,SFEB6_L3Q2,SFEB6_L3Q3,PFEB_L4Q1,PFEB_L4Q2,PFEB_L4Q3,SFEB8_L4Q1,SFEB6_L4Q2,SFEB6_L4Q3"
#FEBs="PFEB_L1Q1,PFEB_L1Q2,PFEB_L1Q3,SFEB8_L1Q1,SFEB8_L1Q2,SFEB8_L1Q3,PFEB_L2Q1,PFEB_L2Q2,PFEB_L2Q3,SFEB8_L2Q1,SFEB8_L2Q2,SFEB8_L2Q3,PFEB_L3Q1,PFEB_L3Q2,PFEB_L3Q3,SFEB8_L3Q1,SFEB8_L3Q2,SFEB8_L3Q3,PFEB_L4Q1,PFEB_L4Q2,PFEB_L4Q3,SFEB8_L4Q1,SFEB8_L4Q2,SFEB8_L4Q3"
...
#CONFIG="/afs/cern.ch/user/s/stgcic/public/configFiles_WedgeTestsB180/Wedge12_20MNIWASP00009_A6_S_P/wedge12layer1234_SFEB8_6.json"
#CONFIG="/afs/cern.ch/user/s/stgcic/public/configFiles_WedgeTestsB180/Wedge14_20MNIWSAC00007_A6_S_C/wedge14layer1234_SFEB8_6.json"
#CONFIG="/afs/cern.ch/user/s/stgcic/public/configFiles_WedgeTestsB180/Wedge13_20MNIWSAC00008_A02_S_C/wedge13layer1234_SFEB8_6.json"
#CONFIG="/afs/cern.ch/user/s/stgcic/public/configFiles_WedgeTestsB180/Wedge16_20MNIWLAP00002/wedge16layer1234_SFEB8_6.json"
...
#     plotting script
 ...
 #    copy to the web
    ...
    echo "<a href='${NOW}_x${R}'> ${NOW}_x${R} </a> :: Wedge 19 Trimming and Baseline scan<br/>" >> $LOG
...
#     copy these stdev on baseline per layer plots for strip pad and wire to the webpage
    ...
    echo "<a href='${NOW}_x${R}_stdev_baseline_perlayerPlots'> ${NOW}_x${R}_stdev_baseline_perlayerPlots </a> :: Wedge 19 Trimming and Baseline scan<br/>" >> $LOG
    echo "Update the log, please: $LOG"
    echo "www.cern.ch/stgc-trimmer/"
