...
MMFE8S="MMFE8_L4P7_IPL"
#MMFE8S="${LAYER3_IP},${LAYER4_IP},${LAYER2_IP},${LAYER1_IP}"

###############MMFE8S="MMFE8_L2P1_HOR"

#MMFE8S="MMFE8_L1P8_IPR,MMFE8_L1P7_IPR,MMFE8_L1P6_IPR"
...
python NSWConfiguration/dev/mm_baselines_NEW_LM.plot.py -t SM -i $OUT/baselines.txt -o $OUT/baselines_${NOW}.root -y 5 | tee $OUT/rms.txt
