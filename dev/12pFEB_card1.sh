...
CONFIG="/afs/cern.ch/user/s/stgcic/public/benchreadout/12pFEBcard1baselineMOfix.json"
...
echo "<a href='${NOW_NEW}'> ${NOW_NEW} </a> :: Batch - 17 June 2020. On-bench Reception Test pFEBs<br/>" >> $LOG
...
readoutName=$SCAs
cd /eos/atlas/atlascerngroupdisk/det-nsw-stgc/benchreadouttest/pFEB/pFEB_17June2020/
mkdir $readoutName
cd /afs/cern.ch/work/s/stgcic/public/sTGC_quick_and_dirty_baselines/NSWConfiguration/dev 
cp -f /afs/cern.ch/work/s/stgcic/public/sTGC_quick_and_dirty_baselines/$newOUT/baselines_outside150to200mV.txt /eos/atlas/atlascerngroupdisk/det-nsw-stgc/benchreadouttest/pFEB/pFEB_17June2020/$readoutName/
cp -f /afs/cern.ch/work/s/stgcic/public/sTGC_quick_and_dirty_baselines/$newOUT/qrcode.txt /eos/atlas/atlascerngroupdisk/det-nsw-stgc/benchreadouttest/pFEB/pFEB_17June2020/$readoutName/
