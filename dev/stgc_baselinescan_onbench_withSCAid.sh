...
#CONFIG="/afs/cern.ch/user/s/stgcic/public/benchtest/felix2/3sFEB8/baseline3sFEB8felix2.json"
...
python NSWConfiguration/dev/benchreadoutcard1.py "$OUT/"
...
echo "<a href='${NOW_NEW}'> ${NOW_NEW} </a> :: On-bench Reception Test retest <br/>" >> $LOG
