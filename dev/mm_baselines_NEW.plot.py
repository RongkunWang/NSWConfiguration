...
def main():
    ...
    chamber_type = "%s" % (type_chamber)

    os.environ["chamber"] = "%s" % (chamber_type)
    ...
    for feb in febs:
        ...
        number_miss_channels = missing_channels(name,chamber_type)
        for bin in range(1, p_sigma.GetNbinsX()+1):
    ...
    os.system("root -l -b nn_new/run.cpp  -q")    
...
def missing_channels(name,chamber_type):
