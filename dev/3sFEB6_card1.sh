# TODO: sTGC 
#FEBs="SFEB8_L1Q1,SFEB6_L1Q2,SFEB6_L1Q3,SFEB8_L2Q1,SFEB6_L2Q2,SFEB6_L2Q3,SFEB8_L3Q1,SFEB6_L3Q2,SFEB6_L3Q3,SFEB8_L4Q1,SFEB6_L4Q2,SFEB6_L4Q3"
#FEBs="SFEB6_L0Q0"
FEBs="SFEB6_L0Q0,SFEB6_L0Q1,SFEB6_L0Q2"
...
#CONFIG="/afs/cern.ch/user/s/stgcic/public/benchreadout/felix2/card1baseline3pFEB.json"
#CONFIG="/afs/cern.ch/user/s/stgcic/public/benchreadout/12sFEBcard1baseline.json"
CONFIG="/afs/cern.ch/user/s/stgcic/public/benchreadout/3sFEB6card1baseline.json"
...
echo "<a href='${NOW_NEW}'> ${NOW_NEW} </a> :: Batch - 17 June 2020. On-bench Reception Test sFEBs retesting with MO open<br/>" >> $LOG
echo "Update the log, please: $LOG"
echo "www.cern.ch/stgc-threshold-on-bench/"



# Moving baseline output file

readoutName=$SCAs
cd /eos/atlas/atlascerngroupdisk/det-nsw-stgc/benchreadouttest/sFEB/sFEB_17June2020/
mkdir $readoutName
cd /afs/cern.ch/work/s/stgcic/public/sTGC_quick_and_dirty_baselines/NSWConfiguration/dev
cp -f /afs/cern.ch/work/s/stgcic/public/sTGC_quick_and_dirty_baselines/$newOUT/baselines_outside150to200mV.txt /eos/atlas/atlascerngroupdisk/det-nsw-stgc/benchreadouttest/sFEB/sFEB_17June2020/$readoutName/
cp -f /afs/cern.ch/work/s/stgcic/public/sTGC_quick_and_dirty_baselines/$newOUT/qrcode.txt /eos/atlas/atlascerngroupdisk/det-nsw-stgc/benchreadouttest/sFEB/sFEB_17June2020/$readoutName/
