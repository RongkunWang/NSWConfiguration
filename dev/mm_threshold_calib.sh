...
#LAYER1="MMFE8_L1P1_IPL,MMFE8_L1P2_IPL,MMFE8_L1P3_IPL,MMFE8_L1P4_IPL,MMFE8_L1P5_IPL,MMFE8_L1P6_IPL,MMFE8_L1P7_IPL,MMFE8_L1P8_IPL,MMFE8_L1P1_IPR,MMFE8_L1P2_IPR,MMFE8_L1P3_IPR,MMFE8_L1P4_IPR,MMFE8_L1P5_IPR,MMFE8_L1P6_IPR,MMFE8_L1P7_IPR,MMFE8_L1P8_IPR"
...
#CONFIG="/afs/cern.ch/user/n/nswdaq/public/sw/config-ttc/config-files/full_small_sector_14_cosmics_IPL1L2_trimmers_x9.json"
#CONFIG="/afs/cern.ch/user/n/nswdaq/public/sw/config-ttc/config-files/full_small_sector_14_cosmics_IPL3L4_trimmers_x9.json"
#CONFIG="/afs/cern.ch/user/n/nswdaq/public/sw/config-ttc/config-files/full_small_sector_cosmics_HOL1L2_trimmers_x9.json"
#CONFIG="/afs/cern.ch/user/n/nswdaq/public/sw/config-ttc/config-files/full_small_sector_cosmics_HOL3L4_trimmers_x9.json"
#CONFIG="/afs/cern.ch/user/n/nswdaq/public/sw/config-ttc/config-files/full_small_sector_14_cosmics_HOL3L4_931.json"
#CONFIG="/afs/cern.ch/user/n/nswdaq/public/sw/config-ttc/config-files/full_small_sector_14_cosmics_HOL1L2_931.json"
CONFIG="/afs/cern.ch/user/n/nswdaq/public/sw/config-ttc/config-files/BB5/A14/full_small_sector_14_cosmics_IPL3L4.json"
...
for R in $(echo ${RMS} | tr "," "\n"); do
    ...
    $BIN/read_channel_monitor -c $CONFIG -s  10 -o $OUT/$R/thresholds_trimmed   --threshold --threads $THREADS --dump -n $MMFE8S
    $BIN/read_channel_monitor -c $CONFIG -s  10 -o $OUT/$R/thresholds_untrimmed --threshold --threads $THREADS --dump -n $MMFE8S -T 0
