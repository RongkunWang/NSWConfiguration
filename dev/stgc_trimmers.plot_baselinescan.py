...
def main():
    ...
    tr_bl      .ReadFile(ops.bl,           "data/C:sTGC_FEB:vmm_id/D:channel_id:tpdac:thdac:trim:ADCsample", " ")
    tr_bl_summ .ReadFile(ops.bl_summ,      "data/C:sTGC_FEB:vmm_str/C:vmm_id/D:channel_str/C:channel_id/D:mean_str/C:mean/D:stdev_str/C:stdev/D:median_str/C:median/D", " ")
...
def plot_gaussian(feb, outfile, tr_bl, tr_bl_summ):
    ...
    for i in range(0, nEntries): 
        tr_bl.GetEntry(i) 
        #print "Branch sTGC_FEB Value ",tr_bl.sTGC_FEB
     ...
     for channel in range(512):    
       ...
       FEB_dir = "Baseline_GaussianFits/"+tr_bl.sTGC_FEB
