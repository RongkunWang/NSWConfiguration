...
def ReadQRCode():
        ...
        if(len(sys.argv) == 2):
                ...
                run_path = sys.argv[1]
		os.system('ping_sca --hostname um-felix2 --from_host_port 12341 --to_host_port 12350 --elinks 00,01,02,80,81,82,100,101,102,180,181,182 > /afs/cern.ch/user/s/stgcic/public/benchtest/tools/SCA_ID_search/output_temp.txt')
