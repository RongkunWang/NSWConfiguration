...
namespace nsw::hw::SCA {
   ...
   */
  void sendI2c(const nsw::internal::OpcClientPtr& opcConnection,
   ...
   */
  void sendI2cRaw(const nsw::internal::OpcClientPtr& opcConnection,
                  const std::string& node,
   ...
   * \param dataSize size of array
   */
  void sendGPIO(const nsw::internal::OpcClientPtr& opcConnection, const std::string& node, bool data);
   ...
   * \param node name of the OPC node
   */
  bool readGPIO(const nsw::internal::OpcClientPtr& opcConnection, const std::string& node);
   ...
   */
  std::vector<std::uint8_t> readI2c(const nsw::internal::OpcClientPtr& opcConnection,
                                    const std::string& node,
   ...
   * \return std::vector<std::uint8_t> Byte vector containing the data
   */
  std::vector<std::uint8_t> readI2cAtAddress(const nsw::internal::OpcClientPtr& opcConnection,
                                             const std::string& node,
   ...
   */
  void sendI2cAtAddress(const nsw::internal::OpcClientPtr& opcConnection,
                        const std::string& node,
   ...
   */
  void sendI2cMasterConfig(const nsw::internal::OpcClientPtr& opcConnection,
   ...
   */
  void sendI2cMasterSingle(const nsw::internal::OpcClientPtr& opcConnection,
                           const std::string& topnode,
                           const nsw::I2cMasterConfig& cfg,
   ...
   */
  void sendSpiRaw(const nsw::internal::OpcClientPtr& opcConnection,
                  const std::string& node,
                  const std::uint8_t* data,
                  size_t dataSize);
   ...
   */
  std::vector<std::uint8_t> readSpi(const nsw::internal::OpcClientPtr& opcConnection,
                                    const std::string& node,
                                    size_t dataSize);
   ...
   */
  void sendSpi(const nsw::internal::OpcClientPtr& opcConnection,
               const std::string& node,
               const std::vector<std::uint8_t>& vdata);
